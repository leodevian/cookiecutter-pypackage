...
- Git hooks setup with [pre-commit](https://pre-commit.com/)
  ...
  - Check for debugger imports and `breakpoint()` calls in Python source with [debug-statements](https://github.com/pre-commit/pre-commit-hooks/blob/main/README.md#debug-statements)
  ...
  - Enforce [GitHub Flavored Markdown](https://github.github.com/gfm/) with [mdformat](https://mdformat.readthedocs.io/en/stable/index.html)
